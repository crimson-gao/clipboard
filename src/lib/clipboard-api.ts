...
export const clipboardApi = {
  ...
  subscribeClipsChanged: (listener: () => void): Unsubscribe => subscribeEvent('clips:changed', listener),
  subscribeOpenSettings: (listener: () => void): Unsubscribe => subscribeEvent('open-settings', listener),
};
